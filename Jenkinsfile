pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://52.91.208.2:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Prem2129/Practical-3.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://52.91.208.2:9090/springapp1"
            echo "✅ Frontend deployed: http://52.91.208.2:9090/frontapp1"
        }
        failure {
